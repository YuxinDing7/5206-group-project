...
g++ -std=c++11 -O0 -mavx2 -DVEC_WIDTH=4  Kmeans_simd.cpp -o kmeans_simd_w4
g++ -std=c++11 -O0 -mavx2 -DVEC_WIDTH=8  Kmeans_simd.cpp -o kmeans_simd_w8
g++ -std=c++11 -O0 -mavx2 -DVEC_WIDTH=16 Kmeans_simd.cpp -o kmeans_simd_w16
echo "run SIMD w4"
